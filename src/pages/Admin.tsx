      ...
      <div className="flex-grow flex items-center justify-center">
        <div className="lg:w-1/2 md:w-3/4 sm:w-full bg-white bg-opacity-80 p-8 rounded shadow-lg">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <Link to="/allocation">
              <button className="w-full bg-gray-500 text-white p-4 rounded-lg hover:bg-gray-700 transition duration-300 focus:outline-none">
                Allocation
              </button>
            </Link>
            <Link to="/attendence">
            ...
            <Link to="/report">
              <button className="w-full bg-orange-500 text-white p-4 rounded-lg hover:bg-orangle-700 transition duration-300 focus:outline-none">
                Generate Report
              </button>
            </Link>
          </div>
